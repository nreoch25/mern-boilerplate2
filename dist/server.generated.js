...
/***/ "./server/config/passport-cookie.js":
/*!******************************************!*\
  !*** ./server/config/passport-cookie.js ***!
  \******************************************/
/*! no static exports found */
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(module) {\n\nvar _mongoose = __webpack_require__(/*! mongoose */ \"mongoose\");\n\nvar _mongoose2 = _interopRequireDefault(_mongoose);\n\nvar _keys = __webpack_require__(/*! ./keys */ \"./server/config/keys.js\");\n\nvar _keys2 = _interopRequireDefault(_keys);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n(function () {\n  var enterModule = __webpack_require__(/*! react-hot-loader */ \"react-hot-loader\").enterModule;\n\n  enterModule && enterModule(module);\n})();\n\nvar JwtStrategy = __webpack_require__(/*! passport-jwt */ \"passport-jwt\").Strategy;\nvar ExtractJwt = __webpack_require__(/*! passport-jwt */ \"passport-jwt\").ExtractJwt;\n\nvar User = _mongoose2.default.model(\"users\");\n\n\nvar extractFromCookie = function extractFromCookie(req) {\n  var token = null;\n  if (req && req.cookies) token = req.cookies[\"mernCookie\"];\n  console.log(\"COOKIE TOKEN\", token);\n  return token;\n};\n\nvar opts = {};\nopts.jwtFromRequest = extractFromCookie;\nopts.secretOrKey = _keys2.default.secretOrKey;\n\nmodule.exports = function (passport) {\n  passport.use(\"cookie\", new JwtStrategy(opts, function (jwt_payload, done) {\n    User.findById(jwt_payload.id).then(function (user) {\n      if (user) {\n        return done(null, user);\n      }\n      return done(null, false);\n    }).catch(function (err) {\n      return console.log(err);\n    });\n  }));\n};\n;\n\n(function () {\n  var reactHotLoader = __webpack_require__(/*! react-hot-loader */ \"react-hot-loader\").default;\n\n  var leaveModule = __webpack_require__(/*! react-hot-loader */ \"react-hot-loader\").leaveModule;\n\n  if (!reactHotLoader) {\n    return;\n  }\n\n  reactHotLoader.register(JwtStrategy, \"JwtStrategy\", \"/Users/nigelreoch/nigel-development/packt/fullstack-react/mern-boilerplate2/server/config/passport-cookie.js\");\n  reactHotLoader.register(ExtractJwt, \"ExtractJwt\", \"/Users/nigelreoch/nigel-development/packt/fullstack-react/mern-boilerplate2/server/config/passport-cookie.js\");\n  reactHotLoader.register(User, \"User\", \"/Users/nigelreoch/nigel-development/packt/fullstack-react/mern-boilerplate2/server/config/passport-cookie.js\");\n  reactHotLoader.register(extractFromCookie, \"extractFromCookie\", \"/Users/nigelreoch/nigel-development/packt/fullstack-react/mern-boilerplate2/server/config/passport-cookie.js\");\n  reactHotLoader.register(opts, \"opts\", \"/Users/nigelreoch/nigel-development/packt/fullstack-react/mern-boilerplate2/server/config/passport-cookie.js\");\n  leaveModule(module);\n})();\n\n;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../node_modules/webpack/buildin/module.js */ \"./node_modules/webpack/buildin/module.js\")(module)))\n\n//# sourceURL=webpack:///./server/config/passport-cookie.js?");

/***/ }),

/***/ "./server/config/passport-header.js":
/*!******************************************!*\
  !*** ./server/config/passport-header.js ***!
  \******************************************/
/*! no static exports found */
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(module) {\n\nvar _mongoose = __webpack_require__(/*! mongoose */ \"mongoose\");\n\nvar _mongoose2 = _interopRequireDefault(_mongoose);\n\nvar _keys = __webpack_require__(/*! ./keys */ \"./server/config/keys.js\");\n\nvar _keys2 = _interopRequireDefault(_keys);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n(function () {\n  var enterModule = __webpack_require__(/*! react-hot-loader */ \"react-hot-loader\").enterModule;\n\n  enterModule && enterModule(module);\n})();\n\nvar JwtStrategy = __webpack_require__(/*! passport-jwt */ \"passport-jwt\").Strategy;\nvar ExtractJwt = __webpack_require__(/*! passport-jwt */ \"passport-jwt\").ExtractJwt;\n\nvar User = _mongoose2.default.model(\"users\");\n\n\nvar opts = {};\nopts.jwtFromRequest = ExtractJwt.fromAuthHeaderAsBearerToken();\nopts.secretOrKey = _keys2.default.secretOrKey;\n\nmodule.exports = function (passport) {\n  passport.use(\"header\", new JwtStrategy(opts, function (jwt_payload, done) {\n    User.findById(jwt_payload.id).then(function (user) {\n      if (user) {\n        return done(null, user);\n      }\n      return done(null, false);\n    }).catch(function (err) {\n      return console.log(err);\n    });\n  }));\n};\n;\n\n(function () {\n  var reactHotLoader = __webpack_require__(/*! react-hot-loader */ \"react-hot-loader\").default;\n\n  var leaveModule = __webpack_require__(/*! react-hot-loader */ \"react-hot-loader\").leaveModule;\n\n  if (!reactHotLoader) {\n    return;\n  }\n\n  reactHotLoader.register(JwtStrategy, \"JwtStrategy\", \"/Users/nigelreoch/nigel-development/packt/fullstack-react/mern-boilerplate2/server/config/passport-header.js\");\n  reactHotLoader.register(ExtractJwt, \"ExtractJwt\", \"/Users/nigelreoch/nigel-development/packt/fullstack-react/mern-boilerplate2/server/config/passport-header.js\");\n  reactHotLoader.register(User, \"User\", \"/Users/nigelreoch/nigel-development/packt/fullstack-react/mern-boilerplate2/server/config/passport-header.js\");\n  reactHotLoader.register(opts, \"opts\", \"/Users/nigelreoch/nigel-development/packt/fullstack-react/mern-boilerplate2/server/config/passport-header.js\");\n  leaveModule(module);\n})();\n\n;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../node_modules/webpack/buildin/module.js */ \"./node_modules/webpack/buildin/module.js\")(module)))\n\n//# sourceURL=webpack:///./server/config/passport-header.js?");
